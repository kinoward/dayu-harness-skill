...
- [plan.md](plan.md) - 历史设计计划和架构追溯
- [phase1-progress.md](phase1-progress.md) - 当前 TypeScript CLI 状态、维护者计划和 QA 经验沉淀
...
- [scaffold-sh-spike.md](scaffold-sh-spike.md) - 历史 Bash 脚手架逻辑 spike 与 TypeScript port 风险记录
...
- [plan.md](plan.md)：历史设计计划和架构追溯；其中 Bash 与测试入口描述不代表当前实现
- [phase1-progress.md](phase1-progress.md)：当前 TypeScript CLI 状态、后续计划、非测试验证基线和临时目录回退 QA 经验
...
- [scaffold-sh-spike.md](scaffold-sh-spike.md)：历史 Bash 脚手架的关键执行语义与 TS port 注意事项
