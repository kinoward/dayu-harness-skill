...
- **[src/cli/](src/cli/)**：Phase 1d TypeScript CLI 垂直切片，提供 init/apply/diagnose/merge/validate/generate 的最小可运行执行层。
