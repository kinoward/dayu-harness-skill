...
- `core`：基础骨架（短根 AGENTS 路由、CLAUDE.md、doc-maintenance、维护脚本）
- `module`：可选能力（practice 文档、Git hooks、GitHub CI、release-please、知识库目录等）

新增能力优先更新能力清单；未启用的能力不会在目标项目生效。
