...
本目录包含工程实践规范文档。每个文档描述一种约束的规则和原理，对应的强制执行脚本位于项目中（如 `.husky/`、`commitlint.config.cjs`）或 Skill 的 `assets/` 中。

## 文档列表

- [commit-guidelines.md](commit-guidelines.md) — Git 提交规范（~50行）
- [pr-guidelines.md](pr-guidelines.md) — PR 提交规范（~100行）
