...
After each implementation segment, self-check against the review checklist. If `github.pr` is enabled, the checklist is `docs/harness/sensors/reviews/code-review-checklist.md`.
